...
export const PROJECT_TYPE = [
  ...
  { label: "Hourly bucket", value: "Hourly bucket" },
...
export const PROJECT_STATUS = [
  ...
  { label: "UAT", value: "UAT" },
  { label: "Support period", value: "Support period" },
...
export const MOBILE_APP = [
  { label: "IOS-Objective C", value: "IOS-Objective C" },
...
export const SERVER = [
  ...
  { label: "Firebase", value: "Firebase" },
  { label: "Liquidweb", value: "Liquidweb" },
  { label: "GoDaddy", value: "GoDaddy" },
];

export const RESOLVED_TYPE = [
  { label: "Yes", value: "Yes" },
  { label: "No", value: "No" },
];
...
export const ESCALATION_TYPE = [
  ...
  { label: "Requirement understanding", value: "Requirement understanding" },
  { label: "Communication", value: "Communication" },
  { label: "Other", value: "Other" },
];

export const COUNTRY_CODE_ARRAY = [
  {
    name: "Afghanistan",
    dialCode: "+93",
    isoCode: "AF",
...
export const RESOURCE_MANAGER = 3;

export const DELIVERY_MANAGER = 4;

export const PROJECT_MANAGER = 5;

export const VICE_PRESIDENT = 6;

export const ASSISTANT_VICE_PRESIDENT = 7;

export const SALES_BDM = 8;

export const SALES_BDE = 9;

export const SALES_BA = 10;

export const SEO_MANAGER = 11;

export const SEO_EXECUTIVE = 12;

export const HR_MANAGER = 13;

export const HR_EXECUTIVE = 14;

export const RECRUITER = 15;

export const ADMIN_EXECUTIVE = 16;

export const WEB_TECH_HEAD = 17;

export const WEB_TECH_LEAD = 18;

export const WEB_TEAM_LEAD = 19;

export const WEB_SENIOR_SE = 20;

export const WEB_SE = 21;

export const WEB_ASE = 22;

export const MOB_TECH_HEAD = 23;

export const MOB_TECH_LEAD = 24;

export const MOB_TEAM_LEAD = 25;

export const MOB_SENIOR_SE = 26;

export const MOB_SE = 27;

export const MOB_ASE = 28;

export const QA_TEAM_LEAD = 29;

export const QA_ENGINEER = 30;

export const WEB_TRAINEE = 31;

export const MOBILE_TRAINEE = 32;

export const QA_TRAINEE = 33;

export const MARKETING_TRAINEE = 34;

export const DESIGN_TECH_HEAD = 35;

export const DESIGN_TECH_LEAD = 36;

export const DESIGN_TEAM_LEAD = 37;

export const DESIGN_SENIOR_SE = 38;

export const DESIGN_SE = 39;

export const DESIGN_ASE = 40;

export const DESIGN_TRAINEE = 41;

export const SYS_ADMIN_MANAGER = 42;

export const SYS_ADMIN_ASSISTANT_MANAGER = 43;

export const SENIOR_SYS_ADMIN = 44;

export const SYS_ADMIN = 45;

export const HARDWARE_EXECUTIVE = 46;

export const ADMIN_TRAINEE = 47;

export const SUPER_ADMIN = 48;

/********DEPARTMENT CONSTANT**************/

export const MANAGEMENT_DEPT = 1;

export const SALES_DEPT = 2;

export const MARKETING_DEPT = 3;

export const HR_DEPT = 4;

export const ADMIN_DEPT = 5;

export const WEB_DEPT = 6;

export const MOBILE_DEPT = 7;

export const QA_DEPT = 8;

export const DESIGN_DEPT = 9;

export const NETWORKING_DEPT = 10;

export const SUPER_ADMIN_DEPT = 11;
